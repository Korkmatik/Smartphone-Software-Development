            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (divisor == inputNumber || divisor == 1) {
                        ...
                        lblResult.setTypeface(null, Typeface.BOLD);
                        lblResult.setTextSize(TypedValue.COMPLEX_UNIT_SP, 24);
                    } else {
                        lblResult.setText(
                                userInput + " " + getString(R.string.not_prime) +
                                        "\n(" + getString(R.string.divisor) + ": " + divisor + ")"
                        );
                        lblResult.setTypeface(null, Typeface.NORMAL);
                        lblResult.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
                    }
